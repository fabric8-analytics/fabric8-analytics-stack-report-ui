...
image:https://ci.centos.org/job/devtools-fabric8-analytics-stack-report-ui-f8a-build-master/badge/icon[Build status, link="https://ci.centos.org/job/devtools-fabric8-analytics-stack-report-ui-f8a-build-master/"]
